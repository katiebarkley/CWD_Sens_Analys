...
#' 
#' #WOLF-ELK Parameters
params <- list(n.predators=70,k_max=1,min.predators=20,max.predators=150,
               r=0.25,k_inflect=3000,n_inflect=2000,numeric.form="Type2", 
               functional.form="Type3",beta.f.low=0.026,beta.m.low=0.026,
               S=5,env.foi=0.0,base.juv=3,base.adult=1,base.old=2,
               p=0.28,selection.form='exponential',stages=c(0:10),
               ...
               hunt.mort.ad.f=0.05,hunt.mort.ad.m=0.1,ini.fawn.prev=0.01,
...
plot(predators$year,predators$population)
time <- c(1:240)
for (t in 1:240){
total.pop[t]<-St.f[1,t]+St.f[2,t]+St.f[3,t]+St.f[4,t]+St.f[5,t]+
St.f[6,t]+St.f[7,t]+St.f[8,t]+St.f[9,t]+St.f[10,t]+St.f[11,t]+St.f[12,t]+
St.f[13,t]+St.f[14,t]+St.f[15,t]+St.f[16,t]+St.f[17,t]+St.f[18,t]
}

plot(time,total.pop,ylab="#sus", xlab="time",type="l")

plot(St.f[2,],predation$Predated_Hf[2,],ylab="#predated", xlab="#susceptible",type="l")

plot(St.f[3,],predation$Predated_Hf[3,],ylab="#predated", xlab="#susceptible",type="l")

plot(St.f[4,],predation$Predated_Hf[4,],ylab="#predated", xlab="#susceptible",type="l")

plot(St.f,predation$Predated_Hf,ylab="#predated", xlab="#susceptible",type="l")


plot.default(time,data3[,3],type="l",xlim=c(0,length(time)),ylim=c(0,25000),
             xlab="Months",ylab="Number of Elk", main="Time Path Elk population w/ Predation")
lines(time,data3[,2], col="red")
lines(time,data3[,1], col="blue")
